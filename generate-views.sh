...
# This script generates all remaining EJS view templates

cd /Applications/XAMPP/xamppfiles/htdocs/alumnihub-nodejs/views

# Auth Register
cat > auth/register.ejs << 'EOF'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="text-center mb-4">
                ...
                <h1 class="h4 mt-3 mb-0">Create Account</h1>
                <p class="text-muted small">Join the VCET Alumni Network</p>
            </div>
            ...
            <form method="POST" action="/auth/register">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control" name="email" placeholder="you@vcet.edu" required>
                    </div>
                </div>
                ...
                <div class="text-center">
                    ...
                    <a href="/auth/login" class="text-decoration-none ms-1"><strong>Login</strong></a>
                </div>
            </form>
        </div>
    </div>
...
cat > auth/forgot-password.ejs << 'EOF'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="text-center mb-4">
                ...
                <h1 class="h4 mt-3 mb-0">Forgot Password</h1>
